...
public class ManagerControllerImpl implements ManagerController {
    ...
    public String fight(String attackUser, String enemyUser) {
        ...
        String attackPlayerHealth = String.valueOf(attackPlayer.getHealth());
        String enemyPlayerHealth = String.valueOf(enemyPlayer.getHealth());
        String message = String.format(FIGHT_INFO, attackPlayerHealth, enemyPlayerHealth);
        return message;
    }
