function solve() {
   ...
   function cardClickEventHandler(e) {
       ...
       let cardDeckID = selectedCard.parentNode.id;
       let cardValue = selectedCard.getAttribute("name");
       markCardAsSelected(selectedCard);
       ...
       if (cardBelongsToFirstPlayer(cardDeckID)) {
           ...
           firstPlayerLastSelectedCard = selectedCard;
       } else {
           ...
           secondPlayerLastSelectedCard = selectedCard;
       }
