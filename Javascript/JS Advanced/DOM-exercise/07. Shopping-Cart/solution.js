function solve() {
 ...
 Array.from(buttonsAdd).map(e=>e.addEventListener("click",function add(e){
  let product=e.target.parentNode.parentNode.getElementsByClassName("product-title")[0].innerHTML;
  let price =e.target.parentNode.parentNode.getElementsByClassName("product-line-price")[0].innerHTML;
